        ...
        for (const entry of entries) {
            if (entry.isDirectory()) {
                ...
                for (const f of localizations) {
                    ...
                    if (img)
                        entriesLoader.push(template.images.add(img.imageType, path_1.join(currentPath, f.name), img.density, lang, options === null || options === void 0 ? void 0 : options.disableImageCheck));
                }
            }
            else {
                ...
                if (img)
                    entriesLoader.push(template.images.add(img.imageType, path_1.join(folderPath, entry.name), img.density, undefined, options === null || options === void 0 ? void 0 : options.disableImageCheck));
            }
        }
        ...
        for await (const entry of zip) {
            ...
            if (/\/?pass\.json$/i.test(entry.fileName)) {
                ...
                if (img) {
                    ...
                    await template.images.add(img.imageType, imgBuffer, img.density, img.lang, options === null || options === void 0 ? void 0 : options.disableImageCheck);
                }
                else {
