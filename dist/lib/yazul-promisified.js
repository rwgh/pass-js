...
Object.defineProperties(yauzl_1.ZipFile.prototype, {
    ...
    openReadStreamAsync: {
        ...
        value: util_1.promisify(yauzl_1.ZipFile.prototype.openReadStream),
    },
    getBuffer: {
        enumerable: true,
        writable: false,
        ...
        async value(entry) {
            ...
            return stream_to_buffer_1.streamToBuffer(stream);
        },
    },
});
exports.unzipBuffer = util_1.promisify(yauzl_1.fromBuffer);
